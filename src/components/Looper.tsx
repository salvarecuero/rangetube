...
export function Looper() {
  ...
  return (
    ...
    >
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center gap-6 px-5 py-10 transition-all duration-500 group-data-[focus=true]/shell:max-w-6xl">
        {!focus && (
